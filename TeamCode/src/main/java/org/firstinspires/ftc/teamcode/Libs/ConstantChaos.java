...
public class ConstantChaos {
    ...
    public static final Pose RedStartingPoseDiagonal = new Pose(22,124, Math.toRadians(-37));
    public static final Pose RedEndingPoseDiagonal = new Pose(60,110, Math.toRadians(0));
    public static final Pose RedGoalArea = new Pose(130, 140);
    ...
    public static final Pose BlueEndingPoseOffTheLine = new Pose(32,7, Math.toRadians(180));
    public static final Pose BlueGoalArea = new Pose(5, 140);
