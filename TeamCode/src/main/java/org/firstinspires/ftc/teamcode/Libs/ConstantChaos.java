...
public class ConstantChaos {
    ...
    public static final Pose RedFirstThree = new Pose(0,0, Math.toRadians(0));//TODO, fill with real numbers
    public static final Pose RedControl = new Pose(0,0);//TODO, fill with real numbers
    ...
    public static final Pose BlueFirstThree = new Pose(0,0,Math.toRadians(180));//TODO, fill with real numbers
    public static final Pose BlueControl =  new Pose(0,0);//TODO, fill with real numbers
