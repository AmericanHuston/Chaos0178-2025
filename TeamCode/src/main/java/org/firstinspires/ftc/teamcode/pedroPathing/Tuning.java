...
public class Tuning extends SelectableOpMode {
    ...
    public static void drawCurrent(Pose Current) {
        try {
    ...
    public static void drawCurrentAndHistory(PoseHistory poseHistory, Pose Current) {
...
class LocalizationTest extends OpMode {
    ...
    public void loop() {
        ...
        drawCurrentAndHistory(follower.getPoseHistory(), follower.getPose());
    }
}
